...
/*   Updated: 2025/03/14 08:58:58 by ahavu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	load_images(t_assets *assets, t_game *game)
{
	...
	if (!assets->wall || !assets->floor || !assets->coll || !assets->exit_closed
...
void	run_game(t_game *game)
{
	...
	mlx_key_hook(game->mlx_ptr, key_hook, (void *[2]){game, assets});
